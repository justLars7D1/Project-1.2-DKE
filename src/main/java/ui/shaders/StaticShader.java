...
public class StaticShader extends ShaderProgram {
    ...
    protected void getAllUniformLocations() {
        ...
        this.locationNumRows = super.getUniformLocation("numRows");
    ...
    public void loadNumRows(float numRows) {
        super.loadFloat(this.locationNumRows, numRows);
    }

    public void loadOffset(float x, float y) {
        super.loadVector(this.locationNumRows, new Vector2f(x, y));
    }
    ...
    public void loadFakeLightingVariable(boolean useFakeLighting) {
        super.loadBoolean(this.locationUseFakeLighting, useFakeLighting);
    }
