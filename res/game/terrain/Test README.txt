...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Test&box=23.949464,61.576125,23.609758,61.414429
...
The original elevation ui.models for this area contained elevations ranging from
...
terrain is even higher. You will likely want to adjust the ui.water level as a
result.
